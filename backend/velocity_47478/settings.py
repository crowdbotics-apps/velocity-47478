"""
Django settings for velocity_47478 project.
...
ROOT_URLCONF = 'velocity_47478.urls'
...
WSGI_APPLICATION = 'velocity_47478.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "velocity_47478 API",
    "DESCRIPTION": "API documentation for velocity_47478 App",
    "VERSION": "v1",
}
